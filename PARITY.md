...
| 42 | Relative pointer | crates/tomoe/src/input.rs | native/protocols.c (untracked WIP) | Missing |
...
| 51 | `honor_xdg_activation_with_invalid_serial` | crates/tomoe/src/handlers.rs, lua.rs | none | Missing |
...
| 58 | Gamma control | crates/tomoe/src/protocols/gamma_control.rs | native/protocols.c (untracked WIP) | Missing |
...
| 61 | Primary selection | crates/tomoe/src/handlers.rs | native/protocols.c (untracked WIP) | Missing |
...
| 73 | `wait_for_frame_completion` | crates/tomoe/src/backend/tty.rs | none | Missing |
...
| 76 | `--backend winit\|tty` names | crates/tomoe/src/main.rs | src/main.lisp (nested/drm) | Partial |
