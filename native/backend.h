...
const char *tomoe_window_identifier(struct tomoe *server, uint32_t id);
...
int tomoe_present_keyboard_grab(struct tomoe *server, const char *owner, uint64_t source_id,
