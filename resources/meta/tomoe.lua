...
---@field force_server_side_decorations boolean # refuse xdg-decoration CLIENT requests and hand every toplevel ServerSide, so CSD-drawing toolkits (GTK4/libadwaita, Qt) skip their own titlebar and the tiled border-only look stays uniform (default false)
